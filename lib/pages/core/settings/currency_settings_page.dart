            ...
            child: SingleChildScrollView(
              child: StreamWrapper(
                ...
                onSuccess: (context, snap) {
                  ...
                  final Currency preferredCurrency = currencies.firstWhere((c) => c.isoCode == 'EUR', orElse: () => currencies.first);
                  final List<Currency> customCurrencies = currencies.where((c) => c.isCustom && c != preferredCurrency).toList();
                  final List<Currency> defaultCurrencies = currencies.where((c) => !c.isCustom && c != preferredCurrency).toList();
                  return Padding(
                    ...
                    child: Column(children: [
                      ...
                      for (final currency in customCurrencies)
